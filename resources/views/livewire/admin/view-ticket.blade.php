                                                    ...
                                                    <div class="inv--detail-section inv--customer-detail-section">
                                                        ...
                                                        <div class="row mt-4">
                                                            ...
                                                            <div class="col-xl-6 col-lg-7 col-md-6 col-sm-4 align-self-center">
                                                                    <a href="javascript:window.history.back()" class="btn btn-light-danger btn-send">Cancel</a>
                                                                    <button wire:click="solved({{$fetchticket->id}})" class="btn btn-success btn-send">Resolved Issue</button>
                            ...
                            <div class="row">
                                <div class="invoice-actions-btn">
                                    <div class="invoice-action-btn">
                                        <div class="row">
                                            <iframe src="{{asset($fetchticket->attachment)}}" frameborder="0"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
