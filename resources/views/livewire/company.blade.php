                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row" style="margin: 30px">
                            ...
                            <div class="col-lg-6 col-12 ">
                                <div class="form-group">
                                    <input wire:click.prevent="updatecompany()" type="submit" value="Update" class="mt-4 btn btn-primary">
                                </div>
                            </div>                                         
                        </div>
                    </div>
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row" style="margin: 30px">
                            ...
                            <div class="col-lg-6 col-12 ">
                                <div class="form-group">
                                    <input wire:click="submitcompany()" type="submit" value="Submit" class="mt-4 btn btn-primary">
                                </div>
                            </div>                                         
                        </div>
                    </div>
