    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu active">
                <a href="{{route('superadmin.dashboard')}}"  class="dropdown-toggle collapse ">
                    <div class="">
            ...
            <li class="menu active">
                <a href="{{route('admin.dashboard')}}" class="dropdown-toggle collapse ">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        <span>Dashboard</span>
                    </div>
            ...
            <li class="menu active">
                <a href="{{route('customer.dashboard')}}" class="dropdown-toggle collapse ">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        <span>Dashboard</span>
                    </div>
            ...
            <li class="menu active">
                <a href="{{route('customeruser.dashboard')}}"  class="dropdown-toggle collapse ">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        <span>Dashboard</span>
                    </div>
            ...
            @if (Auth::user()->login_type=="1")
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="invoice" data-bs-parent="#accordionExample">
                        <li>
                            <a href="{{route("superadmin.listadmin")}}"> List Employee </a>
                        </li>
                        <li>
                            <a href="{{route("superadmin.addadmin")}}"> Add Employee</a>
                        </li>
                    </ul>
                </li>
            @endif
            ...
            @if (Auth::user()->login_type=="1")
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="ecommerce" data-bs-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{route("superadmin.addcustomer")}}">Add Customer</a>
                        </li>
                        <li>
                            <a href="{{route("superadmin.listcustomer")}}">List Customer</a>
                        </li>
                        <li>
                        </li>
                    </ul>
                ...
                <li class="menu">
                    <a href="{{route("superadmin.company")}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="{{route("superadmin.subject")}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
            ...
            @if (Auth::user()->login_type=="2")
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="ecommerce" data-bs-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{route("admin.listcustomer")}}">List Customer</a>
                        </li>
                        <li>
                        </li>
                    </ul>
                ...
                <li class="menu">
                    <a href="{{route('admin.ticket')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
            ...
            @if (Auth::user()->login_type=="3")
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="ecommerce" data-bs-parent="#accordionExample">
                        ...
                        <li>
                            <a href="{{route('customer.adduser')}}">Add User</a>
                        </li>
                        <li>
                            <a href="{{route('customer.listuser')}}">List Users</a>
                        </li>
                        <li>
                        </li>
                    </ul>
                ...
                <li class="menu">
                    <a href="{{route('customer.ticket')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>
                            <span>Tickets</span>
                        </div>
            ...
            @if (Auth::user()->login_type=="3")
                <li class="menu menu-heading">
                    <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>Invoice & Payment</span></div>
                </li>
                <li class="menu">
                    <a href="{{route('customer.gasinvoice')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"></polygon><line x1="8" y1="2" x2="8" y2="18"></line><line x1="16" y1="6" x2="16" y2="22"></line></svg>
                            <span>Gas Invoice</span>
                        </div>
                    </a>
                </li>
                <li class="menu">
            ...
            @if (Auth::user()->login_type=="4")
            <li class="menu">
                <a href="{{route('customeruser.ticket')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>
                        <span>Tickets</span>
                    </div>
            ...
            @if(Auth::user()->login_type=="1")
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="components" data-bs-parent="#accordionExample">
                        <li>
                            <a href="{{route('admin_ticket_resolve')}}"> Admin Tickets </a>
                        </li>
                        <li>
                            <a href="{{route('customer_ticket_resolve')}}"> Customer Tickets </a>
                        </li>
                    </ul>
                </li>
            @endif
